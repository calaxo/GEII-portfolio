...
const content  = [
    ...
    { id: 4,
         ...
         tache:"pour gere des centaines d'apareil et de site et d'objet j'ai du apprenndre  utliser des liste", 
         ressource: "on a appris a faire des base de données",
         trace: "image1",
          evaluation: "evaluation1",
           date: "01/02/2023" },
    ...
    { id: 6,
         ...
         tache:"certain de mes colluege peuvent travailler en teletravail, pour avoir accés au reseaux de l'entreprise nous utlisont un VPN qui crée un tunnel entre leur machine chez eux et notre reseaux, j'ai du apprendre a dépanner ce systeme a distance ", 
    ...
    { id: 8,
         ...
         tache:"en réalisant un projet de renouvelement de bornes wifi j'ai apprise a manipuler des vlan et j'ai decouverte a mes depends que lorsque tout est bien parametré cela rend reduit les vecteur d'ataque cyberinformatique", 
         ressource: "comme je sais fair j'ai fait un site react",
         trace: "image1", 
         evaluation: "evaluation1",
          date: "01/02/2023" },
