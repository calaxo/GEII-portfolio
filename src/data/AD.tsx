...
const content = [
...

  {
    ...
    granddescription:
      "pour se simplifier la tache il est courant d'utiliser des groupes, par exmple le groupe technicient ou direction qui vont tous avoir le meme droit. Cela permet d'etre sur de ne jammais mofifier les droits dans les dossier directement et d'eviter les erreurs",
    ressource: "",
    trace: [],
    evaluation: "",
    date: "08/08/2023",
...

  {
    ...
    tache: "verification des droit pour eviter des fuites de données",
    granddescription:
      "reguliemrnet et pas soucis de sécurité je doit m'assurer que chaque utlisateur est dans le bon groupe, et chaque dossier est accesible par le bon groupe pour permetre de heirachsier les droits, je doit ensuite fair par des mes obesrvation a ma direction",
    ressource: "",
    trace: [],
    evaluation: "",
    date: "05/01/2024",
