...
const content = [
...

  {
    ...
    granddescription: "pour permetre de separer des equipemtn sur des reseaux on peut crér des sous reseaux virtuel dans des reseaux phisyqye pour separer effecicatent les équipement",
    ressource:
      "",
    trace: [imgvlan],
...

  {
    ...
    granddescription: "pour gere tout les equipemtn dans mon entreprise il y a au moins 2 port ethernet dans plus de 30 salle et ilfaut gerer et numeroté tout ces port pour savoir lequel va ou",
