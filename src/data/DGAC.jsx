...
const content = [
  {
    ...
    granddescription: "ce webinar a expliquer comment la direction de l'armement veut reglementer la cybersecurité des entreprise avec qui elle est en lien, c'est pour cela que je doit ameliorer certain aspect de la cybersécurité et que nous allons devoir réaliser des audits",
...

  {
    ...
    granddescription: "J'ai du expliquer par quelles démarches administrative il faut passer et les quelques changement informaituqe qu'il faut appliquer",
...

  {
    ...
    granddescription: "il est par exemple demandé d'avoir un compte administrateur par utlisateur pour permetre de suivre les action et les erreurs, j'ai donc créer un compte admin pour chacun de mes collegue techniciens",
...

  {
    ...
    granddescription: "pour permetre a la DGA de verifier notre infrastrucutre informatique et pour une meilleur transmistion d'information a mes collegue je rédigé des procédure qui explique tout le fonctionment informatique de l'entreprise",
...

  {
    ...
    granddescription: "J'utilise microsfot VISIO professionel qui permet de réaliser des schéma de tout type, ceci va me permetre de detailler tout l'infrastructure dans le meme document",
    ressource: "",
    trace: [imgvisio],
    evaluation: "",
    date: "10/01/2024",
...
const conclu = "Je n'ai pas encore fini car c'est un projet qui prend beaucoup de temps a cause des démarches technique et adminstrative";
