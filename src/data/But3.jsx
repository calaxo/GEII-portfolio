...
const content = [
  ...
  
  {
    ...
    granddescription: "durant mon alternance le reste de mon équipe a eu une carte raspberry pi pour l'utiliser en tant que serveur, j'ai expliqué comment utiliser une base de données mySQL et phpmyadmin pour simplifier la gestion des bases de données",
