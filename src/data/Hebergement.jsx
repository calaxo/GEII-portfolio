...
const content  = [
    ...
    { id: 2,
         ...
         tache:"j'ai ensuite decouvert des service en ligne ou l'on peut transmetre les ficiers a hebrger a un service qui s'occipe de tout",
          ressource: "on a appris a faire des base de données",
          trace: "image1", evaluation: "evaluation1",
           date: "01/02/2023" },


    { id: 3,
         titretache: "creation de backend",
         tache:"en apprendant diférente language de programmtion je me suis intéressé a leur usage pour le web", 
         ressource: "greger",
         trace: "image1",
          evaluation: "evaluation1", 
          date: "01/02/2023" },
    ...
    { id: 4,
         ...
         tache:"en bricoloant des chose et en regardant des tuto j'ai appris les grand principe de fonctionement du WEB avec des requètes, des port, et des adresse", 
         ressource: "on a appris a faire des base de données",
         trace: "image1",
          evaluation: "evaluation1", 
         date: "01/02/2023" },
    ...
    { id: 5,
         ...
         tache:"j'ai decouverte qu'il etait possible en modifiant les parametre d'une box internet d'hberger des sites sur son propre reseaux", 
         ressource: "on a appris a faire des base de données",
         trace: "image1", 
         evaluation: "evaluation1", 
         date: "01/02/2023" },
    ...
    { id: 6,
         ...
         tache:"pour des site personnel j'ai appris a gerer un serveur via un site internet dédié a ceci ou tout est configurable", 
    ...
    { id: 7,
         ...
         tache:"pour avoir mon propre nom de domaine(adresse URL personalisé)j'ai appris a configure un service DNS qui permet de lié un serveur a une adress internet", 
         ressource: "comme je sais fair j'ai fait un site react",
         trace: "image1",
          evaluation: "evaluation1",
          date: "01/02/2023" },
    ...
    { id: 8,
         ...
         tache:"pour heberger des sites dans le reseaux local de mon entreprise j'ai appris a utliser des outils en ligne de commande linux pour heberger efficacement des sites",
          ressource: "comme je sais fair j'ai fait un site react",
          trace: "image1",
           evaluation: "evaluation1",
            date: "01/02/2023" },
