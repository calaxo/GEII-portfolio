...
import imgBaie from "@assetspreuve/baie.png";
...
const intro =
  "Un switch réseau est un appareil qui permet de connecter plusieurs appareils ensemble via Ethernet. J'ai appris à les gérer durant mon alternance dans l'entreprise HUTC.";
...
const content = [
  {
    ...
    tache:
      "Comme pour tout appareil informatique, des mises à jour sont régulièrement créées par les constructeurs.",
...

  {
    ...
    tache:
      "Dans un réseau de particuliers, il y a quelques appareils et au maximum 2 switchs. Mais dans un réseau d'entreprise, tout est plus grand.",
    granddescription:
...
const conclu =
  "C'est le cœur de tous les réseaux informatiques : l'interconnexion. Mais il faut qu'il y ait des règles strictes liées à la cybersécurité pour que tout se passe bien.";
