...
const intro =
  "La veille informatique decrit la prise d'information sur un domaine";
...
const content = [
  ...
  {
    id: 2,
    titretache: "decouverte des nouveautés	",
    tache:
  ...
  {
    id: 3,
    titretache: "amélioration des systèmes	",
    tache:
...
const conclu =
  "comme pour la vie de tout le jous il faut s'informer regulierement pour rester a jour pour savoir quelle sont les dernieres nouveaute et faille trouvé pour ameliorer la cybersécurité";
