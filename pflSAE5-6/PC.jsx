...
const content = [
  ...
  {
    id: 2,
    titretache: "modification de PC avec du vieux matériel",
    tache:
  ...
  {
    id: 3,
    titretache: "choix prix/puissance pour achat",
    tache:
  ...
  {
    id: 4,
    titretache: "montage de PC/serveur à partir de 0",
  ...
  {
    id: 5,
    titretache: "paramétrage du BIOS	",
    tache:
  ...
  {
    id: 6,
    titretache: "installation de l'OS	",
    tache:
  ...
  {
    id: 7,
    titretache: "verification du bon fonctionement et des mise a jour	",
    tache:
...
const conclu =
  "grace a ces competence je peux m'occuper de n'importe quel PC que ce soit pour de la famille des ami ou des collegue, le plus dur et d'expliquer pourquoi ca ne marche pas";
