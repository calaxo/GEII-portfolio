...
const intro =
  "a mon alternance je gere l'administration d'un site de e-learning moodle qui permet aux instructeur de mettre des a dispostion des eleve en passant pas un interface simple et sécurisé";

const content = [
  {
    id: 1,
    titretache: "découverte de moodle",
    tache:
  ...
  {
    id: 2,
    titretache: "création et gestion d'utilisateur",
    tache:
  ...
  {
    id: 3,
    titretache: "ajout et modification de cours",
    tache:
  ...
  {
    id: 4,
    titretache: "nettoyage de la base de données",
    tache:
  ...
  {
    id: 5,
    titretache: "tentative de déplacement de moodle",
    tache:
...
const conclu =
  "j'ai decouvert la compléxité de gerer beacoup d'utilisateur et de cours, et de changer ces droit ou ajouter des cours";
